...
static auto test_note_lookup() -> int {
  ...
  map<string, float> const noteFrequencies = {
      ...
      {"C", 1046.50},  {"C#", 1108.73}, {"D", 1174.66},  {"D#", 1244.51},
      {"E", 1318.51},  {"F", 1396.91},  {"F#", 1479.98}, {"G", 1567.98},
      {"G#", 1661.22}, {"A", 1760.00},  {"A#", 1864.66}, {"B", 1975.53},
      {"C", 2093.00},  {"C#", 2217.46}, {"D", 2349.32},  {"D#", 2489.02},
      {"E", 2637.02},  {"F", 2793.83},  {"F#", 2959.96}, {"G", 3135.96},
      {"G#", 3322.44}, {"A", 3520.00},  {"A#", 3729.31}, {"B", 3951.07},
      {"C", 4186.01},  {"C#", 4434.92}, {"D", 4698.63},  {"D#", 4978.03},
      {"E", 5274.04},  {"F", 5587.65},  {"F#", 5919.91}, {"G", 6271.93},
...
static auto test_chord_lookup() -> int {
  ...
  for (const pair<string, vector<string>> &chord : chord_test_data) {
    ...
    cout << "Chord: " << chord.first << " Guess: " << chord_name << " >> "
         << result << '\n';
  }
